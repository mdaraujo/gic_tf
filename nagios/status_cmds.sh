...
# Memory Usage
python check_docker.py --memory 70:80:GB --containers '^yolo_tf.*'
check_xi_ncpa!-t 'yolo_tf' -P 5693 -M plugins/check_docker.py -q "args=--memory 70:80:GB,args=--containers '^yolo_tf.*'"
